...
#Função para calcular equações diferenciais usando runge-kutta de segunda ordem e imprimir os resultados
def runge_kutta_segunda_ordem(f, y0, t0, tf, h):
    n = int((tf - t0) / h)
    ...
    print(df)
    print(f"\nValor aproximado de y({tf}) pelo método de Runge-Kutta de segunda ordem: {y_values[-1]}")
...
if __name__ == "__main__":
    ...
    runge_kutta_segunda_ordem(f, y0, t0, tf, h)